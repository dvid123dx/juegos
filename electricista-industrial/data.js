...
const vfdControl = {
  ...
  components: [
    ...
    C("VFDRUNaux", "VFD", TPL.contact("NO", "13-14", "13", "14"), 105, 190, { derivedFrom: "VFDRUNcoil" }),
    C("VFDDIRaux", "VFD", TPL.contact("NO", "13-14", "13", "14"), 545, 190, { derivedFrom: "VFDDIRcoil" }),
...
const singlePhaseMotorCombined = {
  ...
  power: {
    ...
    components: [
      ...
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 220, 240, { closedWhen: "K1coil" }),
      C("F2a", "F2", TPL.pole("1-2", "1", "2"), 220, 330),
      C("M", "Motor Monofásico", TPL.singlePhaseMotor(), 220, 420, { runWhen: "K1coil" }),
    ],
    nets: [
      ["railL", "Q1.1"],
      ["Q1.2", "K1a.1"],
...
const twoPhaseHeaterCombined = {
  ...
  power: {
    ...
    components: [
      ...
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 170, 240, { closedWhen: "K1coil" }),
      C("K1b", "K1", TPL.pole("3-4", "3", "4"), 270, 240, { closedWhen: "K1coil" }),
      C("M", "Bomba (motor 1~)", TPL.singlePhaseMotor("L2"), 220, 380, { runWhen: "K1coil" }),
    ],
    nets: [
      ["railL1", "Q1a.1"],
      ["railL2", "Q1b.1"],
...
const sensorActuatorCombined = {
  ...
  power: {
    ...
    components: [
      ...
      railComp("railL2", true, 420, "L2", 300, 90),
      railComp("railL3", true, 420, "L3", 300, 130),
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 220, 220, { closedWhen: "K1coil" }),
      C("K1b", "K1", TPL.pole("3-4", "3", "4"), 300, 220, { closedWhen: "K1coil" }),
      C("K1c", "K1", TPL.pole("5-6", "5", "6"), 380, 220, { closedWhen: "K1coil" }),
      C("F2a", "F2", TPL.pole("1-2", "1", "2"), 220, 320),
      C("F2b", "F2", TPL.pole("3-4", "3", "4"), 300, 320),
      C("F2c", "F2", TPL.pole("5-6", "5", "6"), 380, 320),
      C("M", "Motor Banda", TPL.motor(true), 300, 450, { runWhen: "K1coil" }),
    ],
    nets: [
      ["railL1", "K1a.1"],
      ["railL2", "K1b.3"],
...
const vfdCombined = {
  ...
  power: {
    ...
    components: [
      ...
      C("Q1b", "Q1", TPL.pole("3-4", "3", "4"), 300, 210),
      C("Q1c", "Q1", TPL.pole("5-6", "5", "6"), 380, 210),
      C("VFD", "Variador", TPL.vfd(), 300, 340, { runWhen: "VFDRUNcoil" }),
      C("M", "Motor", TPL.motor(true), 300, 480, { runWhen: "VFDRUNcoil" }),
    ],
    nets: [
      ["railL1", "Q1a.1"],
      ["railL2", "Q1b.3"],
...
const humidityFanCombined = {
  ...
  power: {
    ...
    components: [
      ...
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 200, 180, { closedWhen: "K1coil" }),
      C("M", "Extractor", TPL.singlePhaseMotor(), 200, 300, { runWhen: "K1coil" }),
    ],
    nets: [
      ["railL", "K1a.1"],
      ["K1a.2", "M.L"],
...
const dualFloatPumpCombined = {
  ...
  power: {
    ...
    components: [
      ...
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 140, 220, { closedWhen: "K1coil" }),
      C("K1b", "K1", TPL.pole("3-4", "3", "4"), 220, 220, { closedWhen: "K1coil" }),
      C("K1c", "K1", TPL.pole("5-6", "5", "6"), 300, 220, { closedWhen: "K1coil" }),
      C("F2a", "F2", TPL.pole("1-2", "1", "2"), 140, 320),
      C("F2b", "F2", TPL.pole("3-4", "3", "4"), 220, 320),
      C("F2c", "F2", TPL.pole("5-6", "5", "6"), 300, 320),
      C("M", "Motor Bomba", TPL.motor(true), 220, 440, { runWhen: "K1coil" }),
    ],
    nets: [
      ["railL1", "K1a.1"],
      ["railL2", "K1b.3"],
...
const capacitorBankCombined = {
  ...
  power: {
    ...
    components: [
      ...
      railComp("railN", true, 260, "N", 200, 360),
      C("K1a", "K1", TPL.pole("1-2", "1", "2"), 200, 180, { closedWhen: "K1coil" }),
      C("CB1", "Banco Capacitores", TPL.capacitorBank("CB1"), 200, 300, { energizedWhen: "K1coil" }),
    ],
    nets: [
      ["railL", "K1a.1"],
      ["K1a.2", "CB1.X1"],
...
const slidingDoorCombined = {
  ...
  power: {
    ...
    components: [
      ...
      railComp("railL2", true, 560, "L2", 380, 90),
      railComp("railL3", true, 560, "L3", 380, 130),
      C("KAa", "KA", TPL.pole("1-2", "1", "2"), 160, 220, { closedWhen: "KAcoil" }),
      C("KAb", "KA", TPL.pole("3-4", "3", "4"), 240, 220, { closedWhen: "KAcoil" }),
      C("KAc", "KA", TPL.pole("5-6", "5", "6"), 320, 220, { closedWhen: "KAcoil" }),
      C("KCa", "KC", TPL.pole("1-2", "1", "2"), 440, 220, { closedWhen: "KCcoil" }),
      C("KCb", "KC", TPL.pole("3-4", "3", "4"), 520, 220, { closedWhen: "KCcoil" }),
      C("KCc", "KC", TPL.pole("5-6", "5", "6"), 600, 220, { closedWhen: "KCcoil" }),
      C("F2a", "F2", TPL.pole("1-2", "1", "2"), 300, 320),
      C("F2b", "F2", TPL.pole("3-4", "3", "4"), 380, 320),
      C("F2c", "F2", TPL.pole("5-6", "5", "6"), 460, 320),
      C("M", "Motor Puerta", TPL.motor(true), 380, 440, { runWhen: ["KAcoil", "KCcoil"] }),
    ],
    nets: [
      ["railL1", "KAa.1", "KCb.3"],
      ["railL2", "KAb.3", "KCa.1"],
...
const EXPLORER = [
  {
    ...
    notes: "Falla común: contactos principales picados/pegados por arqueo repetido sin mantenimiento — revisa siempre su estado si el motor 'zumba' sin arrancar.",
    face: "contactor",
  },
  {
    ...
    notes: "Su ajuste (dial de corriente) debe coincidir con la corriente de placa (FLA) del motor real — mal ajustado, dispara de más o deja de proteger.",
    face: "termico",
  },
  {
    ...
    notes: "Suele ser verde por convención — nunca debe usarse un botón NA para la función de paro, ya que un cable roto dejaría el sistema sin forma de detenerse.",
    face: "boton-na",
  },
  {
    ...
    notes: "Suele ser rojo por convención. Este principio (fallar hacia el estado seguro) se llama 'fail-safe' y aparece en casi todo el cableado de seguridad.",
    face: "boton-nc",
  },
  {
    ...
    notes: "A diferencia de un pulsador, queda fijo en la posición elegida — útil para señales de modo que deben mantenerse, no solo pulsarse un instante.",
    face: "selector",
  },
  {
    ...
    notes: "Un piloto apagado no siempre significa falla del circuito principal — primero descarta que sea simplemente el foco fundido.",
    face: "piloto",
  },
  {
    ...
    notes: "Existen variantes 'a la energización' (ON-delay, la más común) y 'a la desenergización' (OFF-delay) — confundirlas es una fuente frecuente de fallas de diagnóstico.",
    face: "timer",
  },
  {
  ...
  },
  {
    ...
    notes: "Casi siempre lleva un fusible propio en el secundario — si el control 'no tiene vida' pero la fuerza sí, revisa primero ese fusible.",
  ...
  },
  {
    ...
    notes: "A diferencia del estrella-triángulo, permite elegir el porcentaje exacto de tensión de arranque cambiando la derivación (tap) utilizada.",
  ...
  },
  {
    ...
    notes: "Conectar en triángulo un motor diseñado para trabajar en estrella (o viceversa) puede sobrecalentarlo o dañarlo — siempre confirma el dato de placa antes de puentear.",
    face: "motor6",
  },
  {
    ...
    notes: "Nunca sustituyas un fusible fundido por uno de mayor amperaje 'para que aguante' — perderías la protección para la que fue calculado el cableado.",
    face: "fusible",
  },
  {
    ...
    notes: "Muchas fallas 'eléctricas' de fin de carrera en realidad son mecánicas: un rodillo desajustado o una palanca doblada que ya no acciona el contacto a tiempo.",
    face: "limitswitch",
  },
  {
    ...
    notes: "En muchos diseños se le agrega un botón de silenciado que corta el sonido sin apagar la lámpara de alarma, para no perder la indicación visual del problema.",
    face: "bocina",
  },
  {
    ...
    notes: "Útil cuando un contactor ya usó todos sus auxiliares disponibles pero el circuito necesita señalizar o enclavar una condición más.",
    face: "rele-auxiliar",
  },
  {
    ...
    notes: "Nunca conectes un contactor entre el VFD y el motor para 'apagarlo' mientras el variador sigue energizado — puede dañar el inversor por apertura bajo carga.",
    face: "vfd",
  },
  {
    ...
    notes: "Es el equivalente en DC de lo que el VFD hace en AC: ambos regulan velocidad variando el voltaje/frecuencia entregado al motor, no con resistencias que disipan energía.",
    face: "chopper",
  },
  {
    ...
    notes: "Cada vez más reemplazado por motores AC con VFD en aplicaciones nuevas, pero sigue siendo común en equipo industrial existente y tracción.",
    face: "motor-dc",
  },
  {
    ...
    notes: "A diferencia de un botón momentáneo, no necesita un contacto de sello aparte: su propia posición mecánica ya es la 'memoria' de la orden.",
    face: "selector-2pos",
  },
  {
    ...
    notes: "A diferencia del VFD, el soft starter no regula la velocidad en marcha continua — solo suaviza el arranque (y a veces el paro) del motor.",
    face: "softstarter",
  },
  {
    ...
    notes: "Tras liberarlo, el sistema NUNCA debe rearmar solo: siempre debe exigir una acción explícita de rearme (un botón aparte) antes de volver a energizar.",
    face: "seta",
  },
  {
    ...
    notes: "Un MCB que se dispara repetidamente casi nunca es una falla del propio disyuntor — indica una sobrecarga o corto real aguas abajo que hay que localizar.",
    face: "mcb",
  },
  {
    ...
    notes: "Un tornillo de clema flojo (falso contacto) es una de las causas de falla intermitente más difíciles de diagnosticar en un tablero real.",
    face: "clema",
  },
  {
    ...
    notes: "Solo detecta metales — para piezas de plástico, cartón o vidrio se necesita un sensor fotoeléctrico en su lugar.",
  ...
  },
  {
    ...
    notes: "Polvo, vapor o suciedad en el lente del emisor/receptor pueden causar detecciones falsas o fallidas — es de las primeras cosas a revisar si 'falla intermitentemente'.",
    face: "sensor-foto",
  },
  {
    ...
    notes: "Un zumbido fuerte y continuo suele indicar que el émbolo está atorado mecánicamente y no logra asentar, no necesariamente una falla eléctrica.",
    face: "actuador",
  },
  {
    ...
    notes: "Un capacitor de arranque en mal estado es una de las causas más comunes de que un motor monofásico 'zumbe' pero no arranque solo.",
...
const QUIZ = [
  ...
  // ---- Teoria basica: Ley de Ohm, potencia y circuitos ----
  { q: "Según la Ley de Ohm, si aumenta la resistencia de un circuito y el voltaje se mantiene constante, ¿qué pasa con la corriente?", a: ["Aumenta en la misma proporción", "Disminuye", "Permanece exactamente igual", "Se vuelve negativa"], correct: 1 },
  { q: "¿Cuál es la fórmula correcta de la Ley de Ohm?", a: ["V = I / R", "V = I × R", "I = V × R", "R = I × V"], correct: 1 },
  { q: "En un circuito puramente resistivo, ¿qué unidad tiene la potencia eléctrica?", a: ["Watts (W)", "Ohms (Ω)", "Amperes (A)", "Henrios (H)"], correct: 0 },
  { q: "¿Qué diferencia hay entre un circuito en serie y uno en paralelo respecto a la corriente?", a: ["En serie es la misma en todos los puntos; en paralelo se divide entre ramas", "En un circuito en paralelo, la corriente total siempre resulta cero", "No hay ninguna diferencia entre ambos tipos de circuito", "En serie la corriente se duplica en cada componente conectado"], correct: 0 },
  { q: "¿Qué le sucede a la resistencia total de dos resistencias iguales conectadas en paralelo?", a: ["Se duplica respecto a una sola resistencia", "Se reduce a la mitad respecto a una sola resistencia", "Permanece exactamente igual", "Se vuelve infinita"], correct: 1 },

  // ---- Trifasico: tension de linea vs de fase ----
  { q: "En una conexión trifásica en estrella, ¿cómo se relaciona la tensión de línea con la tensión de fase?", a: ["Tensión de línea = tensión de fase × √3", "Tensión de línea = tensión de fase / √3", "Ambas tensiones son siempre idénticas", "Tensión de línea = tensión de fase × 3"], correct: 0 },
  { q: "En una conexión trifásica en triángulo (delta), ¿cómo se relaciona la corriente de línea con la corriente de fase?", a: ["Corriente de línea = corriente de fase × √3", "Corriente de línea = corriente de fase / 3", "Ambas corrientes son siempre idénticas", "No existe ninguna relación definida entre ellas"], correct: 0 },
  { q: "¿Por qué un sistema trifásico es preferido sobre uno monofásico para motores industriales de mediana y gran potencia?", a: ["Porque produce un campo magnético rotante de forma natural, sin capacitores auxiliares", "Porque siempre resulta más barato de instalar en cualquier caso", "Porque solo necesita dos conductores en vez de tres", "Porque nunca requiere protección térmica"], correct: 0 },

  // ---- Puesta a tierra, neutro y diferencial ----
  { q: "¿Cuál es la diferencia fundamental entre el conductor neutro y el conductor de tierra física?", a: ["Son eléctricamente idénticos y pueden intercambiarse libremente", "El neutro conduce corriente en operación normal; la tierra solo conduce en caso de falla", "La tierra siempre conduce más corriente que el neutro", "El neutro nunca debe conectarse a ningún punto del sistema"], correct: 1 },
  { q: "¿Qué detecta específicamente un interruptor diferencial (GFCI/RCD)?", a: ["Sobrecargas de corriente sostenidas durante mucho tiempo", "Una fuga de corriente a tierra, comparando ida y retorno", "Cortocircuitos francos directamente entre dos fases", "Bajones prolongados de tensión en la red eléctrica"], correct: 1 },
  { q: "¿Por qué un GFCI/RCD puede salvar una vida donde un interruptor termomagnético normal no lo haría?", a: ["Dispara con fugas mucho menores a las que activan un termomagnético", "Porque siempre tiene mayor capacidad de corriente que uno normal", "Porque reemplaza por completo la necesidad de un guardamotor", "Porque no requiere ningún tipo de prueba periódica de rutina"], correct: 0 },

  // ---- Factor de potencia y transformadores ----
  { q: "¿Qué efecto tiene un factor de potencia bajo (muy inductivo) en una instalación industrial?", a: ["Reduce el consumo de energía facturado por la compañía eléctrica", "Aumenta la corriente necesaria para entregar la misma potencia útil", "Mejora automáticamente la vida útil de todos los motores", "No tiene ningún efecto medible dentro de la instalación"], correct: 1 },
  { q: "¿Cómo se corrige típicamente un factor de potencia bajo en una planta industrial?", a: ["Agregando bancos de capacitores en paralelo con la carga inductiva", "Aumentando la velocidad de los motores mediante un variador", "Instalando más fusibles de protección en la acometida", "Reduciendo el calibre de los conductores de alimentación"], correct: 0 },
  { q: "¿Qué representa la relación de vueltas de un transformador?", a: ["La proporción entre la potencia de entrada y de salida", "La proporción entre el voltaje primario y el secundario", "La cantidad de fusibles que necesita el transformador", "El factor de potencia propio del transformador"], correct: 1 },
  { q: "¿Por qué la capacidad de un transformador se especifica en kVA y no directamente en kW?", a: ["Porque kVA incluye la potencia activa y la reactiva juntas", "Porque kVA y kW son la misma unidad con otro nombre", "Porque los transformadores nunca manejan potencia reactiva", "Es solo una convención sin ningún significado técnico real"], correct: 0 },

  // ---- Motores: placa de datos, deslizamiento y capacitores ----
  { q: "¿Qué es el deslizamiento en un motor de inducción trifásico?", a: ["La diferencia entre la velocidad síncrona y la velocidad real del rotor", "La caída de tensión en los devanados del estátor", "El tiempo que tarda el motor en detenerse tras un paro", "La corriente adicional que consume el motor al arrancar"], correct: 0 },
  { q: "¿Por qué un motor de inducción nunca gira exactamente a su velocidad síncrona bajo carga?", a: ["Necesita cierto deslizamiento para inducir corriente y producir par", "Porque el fabricante lo limita artificialmente por seguridad", "Porque la frecuencia de la línea eléctrica varía todo el tiempo", "Porque el ventilador interno lo frena de forma deliberada"], correct: 0 },
  { q: "En un motor monofásico con capacitor de arranque, ¿qué pasa con ese capacitor una vez que el motor alcanza cierta velocidad?", a: ["Permanece conectado permanentemente durante toda la marcha", "Un interruptor centrífugo (o relé) lo desconecta del circuito", "Se cortocircuita a propósito para aumentar el par", "Se invierte su polaridad automáticamente"], correct: 1 },
  { q: "¿Qué información NO se encuentra típicamente en la placa de datos de un motor?", a: ["Corriente a plena carga (FLA) y tensión nominal", "Factor de servicio y clase de aislamiento", "Potencia (HP o kW) y velocidad nominal (RPM)", "El nombre del técnico que lo instaló por última vez"], correct: 3 },

  // ---- PLC y control programable (introduccion) ----
  { q: "¿Qué son las 'entradas digitales' de un PLC (Controlador Lógico Programable)?", a: ["Señales de dos estados que el PLC lee, como un botón o sensor", "Cables que solo pueden conectarse a lámparas piloto", "Una función exclusiva para controlar variadores de frecuencia", "Un tipo de protección térmica integrada al procesador"], correct: 0 },
  { q: "¿Cuál es una ventaja de reemplazar un cableado de relés por un PLC programado?", a: ["Cambiar la lógica es más rápido: se reprograma en vez de recablear", "Un PLC nunca necesita alimentación eléctrica para funcionar", "Un PLC elimina por completo la necesidad de contactores", "Un PLC siempre resulta más barato que dos relés auxiliares"], correct: 0 },
  { q: "En terminología de PLC, ¿qué es una 'salida' que energiza un contactor de motor?", a: ["Una señal de entrada que el PLC recibe de un sensor externo", "Una señal que el PLC envía al mundo exterior para accionar un dispositivo", "Un tipo de protección contra sobrecargas integrada al procesador", "Un parámetro de configuración de la fuente de alimentación del PLC"], correct: 1 },

  // ---- Seguridad electrica avanzada ----
  { q: "¿Qué es un 'arco eléctrico' (arc flash) en el contexto de seguridad industrial?", a: ["Una descarga luminosa muy energética al abrir o cerrar un circuito en falla", "Un tipo de iluminación decorativa usada en tableros eléctricos", "Un método seguro para medir tensión sin desenergizar nada", "Un sinónimo exacto de cortocircuito, sin riesgo adicional alguno"], correct: 0 },
  { q: "¿Por qué NFPA 70E recomienda categorías de riesgo de arco eléctrico (Arc Flash Categories)?", a: ["Definen qué equipo de protección personal se requiere según la energía", "Para decidir el color de pintura que llevará cada tablero eléctrico", "Para clasificar exclusivamente el tamaño físico del gabinete", "Es solo una recomendación estética sin relación con la seguridad"], correct: 0 },
  { q: "¿Cuál es el propósito principal del procedimiento LOTO (Lockout/Tagout)?", a: ["Etiquetar visualmente el color de los conductores de un tablero", "Bloquear una fuente de energía peligrosa mientras alguien trabaja en el equipo", "Medir la resistencia de aislamiento de los devanados de un motor", "Programar el arranque automático de un equipo tras el mantenimiento"], correct: 1 },
  { q: "Al aplicar LOTO en un tablero, ¿por qué conviene verificar con un multímetro que el circuito esté realmente desenergizado?", a: ["Porque el candado del LOTO no es, por sí solo, una prueba de ausencia de tensión", "Porque no es necesario, el candado ya lo garantiza por completo", "Solo se hace por costumbre, sin ninguna razón real de seguridad", "Porque los multímetros siempre dan lecturas erróneas ahí"], correct: 0 },

  // ---- Corriente alterna vs directa, frecuencia y armonicos ----
  { q: "¿Cuál es la diferencia fundamental entre corriente alterna (CA) y corriente directa (CD)?", a: ["La CA cambia de sentido periódicamente; la CD fluye en un solo sentido", "La CD siempre tiene mayor voltaje nominal que la CA", "No existe ninguna diferencia real entre ambas formas", "La CA solamente puede generarse usando baterías"], correct: 0 },
  { q: "¿Qué representa la frecuencia de una red eléctrica de 60 Hz?", a: ["La corriente completa 60 ciclos enteros cada segundo", "El voltaje cambia exactamente 60 veces por hora", "Es la cantidad de fases que tiene el sistema", "Es el número de polos del motor conectado a la red"], correct: 0 },
  { q: "¿Qué son los armónicos que puede introducir un VFD en una instalación eléctrica?", a: ["Distorsiones de la onda senoidal por la conmutación electrónica", "Un tipo de protección térmica adicional del variador", "Vibraciones mecánicas normales del motor al arrancar", "Una característica exclusiva de los motores monofásicos"], correct: 0 },

  // ---- Frenado de motores, eficiencia y clases de aislamiento ----
  { q: "¿Qué es el 'frenado dinámico' (regenerativo) en un VFD?", a: ["El motor actúa como generador al frenar, y el variador disipa o reinyecta esa energía", "Un método para invertir el sentido de giro sin detener el motor", "Una función exclusiva para arrancar motores monofásicos", "Un tipo de protección contra sobretensión en la línea de entrada"], correct: 0 },
  { q: "¿Para qué sirve una resistencia de frenado (braking resistor) conectada a un VFD?", a: ["Disipa en forma de calor la energía que el motor regresa al frenar", "Reduce el consumo de energía durante el arranque normal", "Sustituye por completo al relé térmico de protección", "Aumenta la velocidad máxima que puede alcanzar el motor"], correct: 0 },
  { q: "¿Qué indican las clases de eficiencia IE (IE1 a IE4) en un motor de inducción?", a: ["El nivel de eficiencia: a mayor número, menor pérdida de energía", "La cantidad de polos que tiene el motor internamente", "El tipo de arranque recomendado para ese motor específico", "La clase de aislamiento térmico de sus propios devanados"], correct: 0 },
  { q: "¿Qué representa la clase de aislamiento (A, B, F o H) en la placa de datos de un motor?", a: ["La temperatura máxima que soporta el aislamiento sin degradarse", "El nivel de protección contra polvo y agua de la carcasa", "El tipo de conexión, estrella o triángulo, del motor", "La cantidad de fases que requiere para funcionar bien"], correct: 0 },
  { q: "¿Qué significa un grado de protección IP54 en la carcasa de un motor o gabinete?", a: ["Protección limitada contra polvo y contra salpicaduras de agua desde cualquier dirección", "Protección total contra inmersión completa y prolongada en agua", "No ofrece ninguna protección contra polvo ni contra líquidos", "Se refiere únicamente a la resistencia mecánica ante impactos"], correct: 0 },

  // ---- Practicas de cableado y conexiones ----
  { q: "¿Por qué se recomienda usar terminales de compresión (conectores tipo ojo o pala) en vez de solo trenzar los cables?", a: ["Ofrecen una conexión mecánica y eléctrica más firme y confiable a largo plazo", "Son obligatorios únicamente por motivos estéticos del tablero", "Reducen la corriente que puede pasar por el conductor", "Eliminan por completo la necesidad de fusibles en el circuito"], correct: 0 },
  { q: "¿Qué riesgo principal implica una conexión floja en una terminal de un contactor o clema?", a: ["Sobrecalentamiento local, con riesgo de falla o incendio", "Ninguno, mientras el cable siga físicamente en su lugar", "Un aumento notable en la vida útil del componente", "Una mejora automática del factor de potencia del circuito"], correct: 0 },
  { q: "¿Por qué es buena práctica identificar cada cable de un tablero con un número o etiqueta que coincida con el diagrama?", a: ["Facilita enormemente el diagnóstico y el mantenimiento futuro del tablero", "Es un requisito estético sin ningún beneficio técnico real", "Aumenta la capacidad de corriente que soporta el conductor", "Sustituye la necesidad de tener el diagrama eléctrico a la mano"], correct: 0 },
  { q: "¿Qué ventaja ofrece usar canaletas (wireducts) dentro de un tablero en vez de dejar los cables sueltos?", a: ["Organiza y protege el cableado, facilitando su seguimiento y mantenimiento", "Aumenta la tensión disponible en el circuito de control", "Elimina por completo la necesidad de un térmico de protección", "Convierte automáticamente el circuito en trifásico"], correct: 0 },

  // ---- Sistemas de respaldo y calidad de energia ----
  { q: "¿Cuál es la diferencia principal entre un UPS (No-Break) y una planta de emergencia (generador)?", a: ["El UPS entrega energía de batería de forma instantánea; el generador necesita tiempo para arrancar", "Ambos son exactamente el mismo tipo de equipo con distinto nombre comercial", "El generador siempre es más rápido que el UPS para responder a un corte", "Un UPS solo puede alimentar lámparas piloto, nunca equipo de cómputo"], correct: 0 },
  { q: "¿Por qué muchos sistemas críticos combinan un UPS con un generador de respaldo, en vez de usar solo uno de los dos?", a: ["El UPS cubre el corte instantáneamente mientras el generador arranca y se estabiliza", "Porque la ley exige tener ambos equipos sin ninguna razón técnica", "Porque el generador nunca puede alimentar cargas sensibles de cómputo", "Porque el UPS puede sostener la carga indefinidamente sin recargarse"], correct: 0 },
  { q: "¿Qué es la 'calidad de la energía' (power quality) en una instalación eléctrica?", a: ["Qué tan limpia, estable y libre de interrupciones es la tensión suministrada", "El color de los conductores usados en toda la instalación", "La cantidad de contactores instalados en el tablero principal", "El tipo específico de motor conectado a la red eléctrica"], correct: 0 },

  // ---- Simbologia y practica de diagramas ----
  ...
  // ---- Conductores, canalizaciones y protecciones adicionales ----
  { q: "¿Qué es el 'llenado de conducto' (conduit fill) al calcular cuántos cables caben en una tubería?", a: ["El porcentaje del área interna que pueden ocupar los conductores, según norma", "La cantidad exacta de amperes que soporta el conducto metálico", "El número de codos permitidos entre dos cajas de registro", "La resistencia de aislamiento mínima exigida para el conducto"], correct: 0 },
  { q: "¿Qué diferencia práctica hay entre un conducto EMT (metálico delgado) y uno PVC?", a: ["El EMT ofrece protección mecánica y puede servir de tierra; el PVC no conduce y es más ligero", "Ambos son eléctricamente y mecánicamente idénticos en cualquier aplicación", "El PVC siempre soporta mayor amperaje que el EMT del mismo diámetro", "El EMT solo puede usarse en instalaciones subterráneas"], correct: 0 },
  { q: "¿Por qué la coordinación de protecciones (selectividad) es importante entre un interruptor principal y uno derivado?", a: ["Para que ante una falla dispare primero el más cercano al problema, no el principal", "Para que ambos disparen siempre al mismo tiempo sin excepción", "Porque así lo exige únicamente la estética del tablero", "Para reducir el número total de fusibles en la instalación"], correct: 0 },
  { q: "¿Qué es la protección contra 'pérdida de fase' (single-phasing) en un motor trifásico?", a: ["Detecta si falta una de las tres fases y desconecta el motor antes de que se dañe", "Aumenta automáticamente la velocidad del motor si falta una fase", "Convierte el motor trifásico en monofásico de forma temporal", "Es un sinónimo exacto de protección contra sobretensión"], correct: 0 },
  { q: "¿Por qué perder una fase mientras el motor sigue girando es especialmente peligroso para el devanado?", a: ["Las dos fases restantes deben suministrar toda la corriente, sobrecalentando el motor", "El motor se detiene de inmediato sin ningún riesgo adicional", "La velocidad del motor se reduce a cero instantáneamente", "No representa ningún riesgo real para el devanado del motor"], correct: 0 },

  // ---- Transferencia, resonancia y variadores (temas avanzados) ----
  { q: "¿Qué diferencia hay entre una transferencia 'de transición abierta' y una 'de transición cerrada' en un ATS?", a: ["La abierta interrumpe un instante la carga; la cerrada traslapa ambas fuentes", "Ambas son exactamente el mismo tipo de transferencia, con otro nombre", "La transición cerrada nunca puede usarse con un generador de respaldo", "La transición abierta siempre requiere dos generadores en paralelo"], correct: 0 },
  { q: "¿Qué riesgo existe al agregar un banco de capacitores para corregir el factor de potencia sin un estudio previo?", a: ["Puede generar resonancia con la impedancia de la red y amplificar armónicos existentes", "Ninguno, los capacitores nunca interactúan con otros equipos de la instalación", "Reduce automáticamente la vida útil de los motores conectados", "Elimina por completo la necesidad de guardamotores en la planta"], correct: 0 },
  { q: "¿Qué es la 'frecuencia portadora' (carrier frequency) de conmutación en un VFD?", a: ["La frecuencia a la que conmutan los IGBT para sintetizar la salida", "La frecuencia de línea de entrada, siempre fija en 50 o 60 Hz", "La velocidad de giro nominal del motor conectado al VFD", "Un parámetro exclusivo de los motores monofásicos antiguos"], correct: 0 },
  { q: "¿Por qué aumentar la frecuencia portadora de un VFD puede reducir el ruido audible del motor?", a: ["Saca el ruido de conmutación del rango audible, a costa de más pérdidas", "Porque reduce la velocidad real de giro del motor conectado", "Porque desconecta automáticamente el ventilador del motor", "No tiene ninguna relación real con el ruido del motor"], correct: 0 },

  // ---- Servicio, ciclo de trabajo y clases de sobrecarga ----
  { q: "¿Qué indica el 'factor de servicio' (service factor) en la placa de un motor?", a: ["Cuánto puede sobrecargarse el motor sin dañarse de inmediato", "La cantidad de fases que requiere el motor para arrancar", "El tipo exacto de conexión, estrella o triángulo, del motor", "La clase de aislamiento térmico de sus propios devanados"], correct: 0 },
  { q: "¿Qué representan las clases de disparo de un relé térmico (Clase 10, 20, 30)?", a: ["El tiempo máximo de disparo ante 6 veces la corriente nominal", "La cantidad de polos que trae ese relé térmico específico", "El número de rearmes permitidos antes de reemplazarlo", "La tensión máxima que soporta el contacto auxiliar 95-96"], correct: 0 },
  { q: "¿Qué es el 'ciclo de trabajo' (duty cycle, ej. S1-S9) especificado en algunos motores?", a: ["Describe el patrón de operación para el que fue diseñado el motor", "El número de vueltas que da el rotor por cada ciclo de línea", "La cantidad de veces que se puede rearmar el térmico en un día", "Es un sinónimo exacto de la clase de aislamiento del motor"], correct: 0 },

  // ---- Puesta a tierra y proteccion contra sobretensiones ----
  { q: "¿Qué función cumple un electrodo de puesta a tierra (varilla copperweld) en una instalación?", a: ["Da una trayectoria de baja resistencia a tierra para fallas y picos", "Aumenta la tensión disponible en el circuito de control", "Sustituye la necesidad de cualquier interruptor diferencial", "Se usa únicamente en instalaciones de corriente directa"], correct: 0 },
  { q: "¿Cuál es la diferencia entre el 'conductor de puesta a tierra' y el 'conductor de bonding' (unión equipotencial)?", a: ["El primero va a tierra física; el segundo une partes metálicas entre sí", "Son exactamente el mismo conductor, con dos nombres distintos", "El bonding siempre lleva más corriente que la tierra física", "El bonding solo se usa en circuitos de corriente directa"], correct: 0 },
  { q: "¿Para qué sirve un dispositivo de protección contra sobretensiones (SPD / supresor de picos)?", a: ["Limita picos de voltaje transitorios antes de que dañen el equipo", "Reemplaza por completo la función de un interruptor diferencial", "Aumenta la corriente disponible para arrancar motores grandes", "Sirve únicamente para filtrar armónicos de un VFD"], correct: 0 },
  { q: "¿Qué distingue a un interruptor de falla de arco (AFCI) de uno diferencial (GFCI)?", a: ["El AFCI detecta arqueo (riesgo de incendio); el GFCI, fugas a tierra", "Son exactamente el mismo dispositivo con distinto nombre comercial", "El GFCI protege contra incendios y el AFCI contra choques eléctricos", "Ninguno de los dos existe realmente en la práctica"], correct: 0 },

  // ---- Comparacion de metodos de arranque ----
